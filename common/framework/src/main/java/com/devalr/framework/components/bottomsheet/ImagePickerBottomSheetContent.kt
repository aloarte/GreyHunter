...
fun ImagePickerBottomSheetContent(
    ...
    Column(
        ...
        GHText(
            text = stringResource(R.string.bs_pick_picture_description),
...
@Composable
private fun ImagePickerBottomSheetContentPreviewDarkTheme() {
...
@Preview(showBackground = true)
@Composable
private fun ImagePickerBottomSheetContentPreviewLightTheme() {
